        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function OnRequestDepartment(SchoolId) {
                    ...
                    var YearTerm = $find("<%=ccmbTerm.ClientID %>").get_value(); //学年学期 
                    var DataSignId = $find("<%=ccmbDataSign.ClientID %>").get_value();//数据标识
                    oWnd.setUrl(encodeURI("../Declaration/DepartmentProgress.aspx?SchoolId=" + SchoolId + "&YearTerm=" + YearTerm + "&DataSignId=" + DataSignId)); //
                    oWnd.show();
                    oWnd.setSize(700, 520);
                }
            </script>
                            ...
                            <tr>
                                ...
                                <td>
                                    <utm:UTMisComboBox runat="server" ID="ccmbDataSign" AutoPostBack="True" IsMaintainSelectedValue="true" SkinID="cmb120" Label="数据标识"
                                        DataTextField="DataSignName" DataValueField="DataSignId" OnBeforeDataBind="ccmbDataSign_BeforeDataBind" OnAfterDataBind="cbtnQuery_Click"
                                        OnSelectedIndexChanged="ccmbDataSign_SelectedIndexChanged">
                                    </utm:UTMisComboBox>
                                </td>
                                <td>
                    ...
                    <utm:UTMisGrid runat="server" ID="cgrdDeclarationList" SkinID="AutoHeight"
                        ...
                        <MasterTableView EnableNoRecordsTemplate="true" NoMasterRecordsText="没有数据可以显示">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="SchoolName" HeaderStyle-Width="200" HeaderText="学院名称">
                                ...
                                <telerik:GridBoundColumn HeaderText="未完成申报数" DataField="RestCount"></telerik:GridBoundColumn>
<%--                                <telerik:GridTemplateColumn HeaderText="未完成申报数" DataField="RestCount">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn>
                                    <ItemTemplate>
                                        <asp:Button ID="btn" runat="server" PostBackUrl="~/Declaration/DepartmentProgress.aspx" Visible="true" Text="查看" />
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridBoundColumn DataField="SchoolId" Visible="false"></telerik:GridBoundColumn>
                            </Columns>
                        </MasterTableView>
                    </utm:UTMisGrid>
                </utm:UTMisPageView>
