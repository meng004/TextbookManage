...
{
    public partial class StudentTextbookDeclaration : Page
    {
        ...
        protected void cbtnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (CheckDeclarationInfo())
            {
                ...
                if (views.Count > 0 || books.Count > 0)
                {
                    ...
                    _declaration.SubmitDeclarationForStudent(views, books.First(), ctxtHomePhone.Text.Trim(), ctxtMobile.Text.Trim(), ctxtAmount.Text.Trim(), ref message);
        ...
        private void CalculateDeclarationCount()
        {
            ...
            var views = cgrdTeachingClassList.GetAllCheckedDataList<TeachingTaskView>();
            //计算人数
            ctxtAmount.Text = _declaration.CalculateDeclarationCount(views);
        }
