<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserNamePasswordUpdate.aspx.cs" Inherits="CPMis.WebPage.SystemManageUI.UserManageUI.UserNamePasswordUpdate" %>
                            ...
                            <table style="width: 320px; text-align: left;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%--<asp:RequiredFieldValidator ID="rfv_Password" runat="server"  Display="Dynamic" ErrorMessage="密码不能为空!" 
                                        ControlToValidate="txt_NewPass"></asp:RequiredFieldValidator>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" align="center">
                                        <cp:CPMisButton ID="btn_SavePass" runat="server" Text="修 改" 
                                        OnClick="btn_SavePass_Click"/>
