...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <cp:CPMisToolBar ID="ctlbTextbook" runat="server">
                <Items>
        ...
        <div>
            <cp:CPMisTabStrip runat="server" ID="tabStrip" MultiPageID="mp_Textbook">
                <Tabs>
                    <cp:CPMisTab runat="server" Text="新增教材信息" PageViewID="pv_Textbook" Selected="true">
                    </cp:CPMisTab>
                </Tabs>
            </cp:CPMisTabStrip>
