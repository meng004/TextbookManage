<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlertAdd.aspx.cs" Inherits="CPMis.WebPage.Tb_Maintain.Tb_Maintain_19.AlertAdd" %>
        ...
        <cp:cpmismultipage runat="server" id="cteacher" skinid="Long">
            <cp:CPMisPageView ID="CPMisPageView1" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="border" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="vldRequiredAlertName" runat="server" ValidationGroup="BaseInfoGroup"
                                ErrorMessage="请输入提醒名称!" ControlToValidate="ctxtAlertName" Display="None"></asp:RequiredFieldValidator>
                        ...
                        <td class="border" align="left">
                            <asp:Label ID="lblAlert" Text="例如: 2011年春季教材征订开始" runat="server" ForeColor="Gray">
                            </asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="border" align="left">
                           ...
                           <asp:RequiredFieldValidator ID="vldBeginDate" runat="server" ValidationGroup="BaseInfoGroup"
                                ...
                                <%--<asp:RegularExpressionValidator ID="vldRegBeginDate" ValidationExpression="\d{4}-\d{2}-\d{2}"
                                ControlToValidate="cdateBeginDate" ErrorMessage="请输入正确的开始日期格式" runat="server" Display="None"
                                ValidationGroup="BaseInfoGroup" />--%>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="border" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="vldEndDate" runat="server" ValidationGroup="BaseInfoGroup"
                               ...
                               <%-- <asp:RegularExpressionValidator ID="vldRegEndDate" ValidationExpression="\d{4}-\d{2}-\d{2}"
                                ControlToValidate="cdateEndDate" ErrorMessage="请输入正确的结束日期格式" runat="server" Display="None"
                                ValidationGroup="BaseInfoGroup" />--%>
                ...
                <div style="text-align: center">
                    <cp:CPMisButton ID="cbtnSubmit" runat="server" OnClick="cbtnSubmit_Click" Text="确定"
                        SkinID="bt60" ValidationGroup="BaseInfoGroup" OnClientClick="return OnClientValidateClick('BaseInfoGroup')" />
                        <%--OnClientClick="return confirm('是否添加?')"--%>
                    &nbsp; &nbsp;
