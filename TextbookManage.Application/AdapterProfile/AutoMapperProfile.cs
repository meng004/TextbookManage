    ...
    public class AutoMapperProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<TeachingTask, TeachingTaskView>()
                .ForMember(v => v.TeacherName, m => m.MapFrom(s => s.Teachers.Count() == 0 ? s.ResponsibilityTeacher.Name : s.Teachers.First().Name))
            ...
            Mapper.CreateMap<Textbook, TextbookView>()
                ...
                .ForMember(v => v.Press, m => m.MapFrom(s => s.Press.Name))
            ...
            Mapper.CreateMap<TextbookView, Textbook>()
                .ForMember(m => m.TextbookId, v => v.MapFrom(s => string.IsNullOrWhiteSpace(s.TextbookId) ? System.Guid.Empty : s.TextbookId.ConvertToGuid()))
            ...
            Mapper.CreateMap<Student, StudentView>()
                .ForMember(v => v.Gender, m => m.MapFrom(s => s.Sex));
            ...
            Mapper.CreateMap<DeclarationView, Declaration>()
                .ForMember(m => m.DeclarationId, v => v.MapFrom(s => s.DeclarationId.ConvertToInt()));
            ...
            Mapper.CreateMap<SchoolProgress, SchoolProgressView>()
                .ForMember(v => v.SchoolId, m => m.MapFrom(s => s.School.SchoolId))
            ...
            Mapper.CreateMap<DepartmentProgress, DepartmentProgressView>()
                .ForMember(v => v.SchoolId, m => m.MapFrom(s => s.School.SchoolId))
                .ForMember(v => v.Name, m => m.MapFrom(s => s.School.Name))
                .ForMember(v => v.DepartmentId, m => m.MapFrom(s => s.Department.DepartmentId))
            ...
            Mapper.CreateMap<StorageView, Storage>()
                .ForMember(m => m.StorageId, v => v.MapFrom(s => s.StorageId.ConvertToInt()))
            ...
            Mapper.CreateMap<InventoryView, Inventory>()
                .ForMember(m => m.InventoryId, v => v.MapFrom(s => s.InventoryId.ConvertToInt()))
                .ForMember(m => m.Textbook_Id, v => v.MapFrom(s => s.TextbookId.ConvertToGuid()))
            ...
            Mapper.CreateMap<StockRecord, StockRecordView>()
                ...
                .ForMember(v => v.Press, m => m.MapFrom(s => s.Inventory.Textbook.Press.Name))
